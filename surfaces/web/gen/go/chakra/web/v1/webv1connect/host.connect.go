...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/panyam/chakra/surfaces/web/gen/go/chakra/web/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HostServiceName = "chakra.web.v1.HostService"
)
...
// NewHostServiceClient constructs a client for the chakra.web.v1.HostService service. By default,
...
func NewHostServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HostServiceClient {
	...
	hostServiceMethods := v1.File_chakra_web_v1_host_proto.Services().ByName("HostService").Methods()
...
// Watch calls chakra.web.v1.HostService.Watch.
...
// Submit calls chakra.web.v1.HostService.Submit.
...
// Dispatch calls chakra.web.v1.HostService.Dispatch.
...
// RespondToAsk calls chakra.web.v1.HostService.RespondToAsk.
...
// ListSessions calls chakra.web.v1.HostService.ListSessions.
...
// GetStatus calls chakra.web.v1.HostService.GetStatus.
...
// CreateSession calls chakra.web.v1.HostService.CreateSession.
...
// ListWebSessions calls chakra.web.v1.HostService.ListWebSessions.
...
// CloseSession calls chakra.web.v1.HostService.CloseSession.
...
// HostServiceHandler is an implementation of the chakra.web.v1.HostService service.
...
func NewHostServiceHandler(svc HostServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chakra.web.v1.HostService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHostServiceHandler) Watch(context.Context, *connect.Request[v1.WatchRequest], *connect.ServerStream[v1.Frame]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.Watch is not implemented"))
}
...
func (UnimplementedHostServiceHandler) Submit(context.Context, *connect.Request[v1.SubmitRequest]) (*connect.Response[v1.SubmitResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.Submit is not implemented"))
}
...
func (UnimplementedHostServiceHandler) Dispatch(context.Context, *connect.Request[v1.DispatchRequest]) (*connect.Response[v1.DispatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.Dispatch is not implemented"))
}
...
func (UnimplementedHostServiceHandler) RespondToAsk(context.Context, *connect.Request[v1.RespondToAskRequest]) (*connect.Response[v1.RespondToAskResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.RespondToAsk is not implemented"))
}
...
func (UnimplementedHostServiceHandler) ListSessions(context.Context, *connect.Request[v1.ListSessionsRequest]) (*connect.Response[v1.ListSessionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.ListSessions is not implemented"))
}
...
func (UnimplementedHostServiceHandler) GetStatus(context.Context, *connect.Request[v1.GetStatusRequest]) (*connect.Response[v1.GetStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.GetStatus is not implemented"))
}
...
func (UnimplementedHostServiceHandler) CreateSession(context.Context, *connect.Request[v1.CreateSessionRequest]) (*connect.Response[v1.CreateSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.CreateSession is not implemented"))
}
...
func (UnimplementedHostServiceHandler) ListWebSessions(context.Context, *connect.Request[v1.ListWebSessionsRequest]) (*connect.Response[v1.ListWebSessionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.ListWebSessions is not implemented"))
}
...
func (UnimplementedHostServiceHandler) CloseSession(context.Context, *connect.Request[v1.CloseSessionRequest]) (*connect.Response[v1.CloseSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chakra.web.v1.HostService.CloseSession is not implemented"))
}
